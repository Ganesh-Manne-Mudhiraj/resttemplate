...
public class SchoolController {
	...
	public String getTest(){
		...
		//final String uri = "http://studentservicerest1.cfapps.io/student/all";
	...
	public ResponseEntity<String> postTest(){
		final String uri = "http://localhost:8081/student/test2";
	...
	public ResponseEntity<String> restTemplatePathVarTest() {
		final String uri = "http://localhost:8081/student/test4/101";
	...
	public ResponseEntity<String> restTemplateRebodyTest() throws Exception {
		...
		request.put("id", 101);
		request.put("name", "usk");
		request.put("address", "HYD");
